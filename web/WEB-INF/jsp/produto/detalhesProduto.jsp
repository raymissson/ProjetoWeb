<%-- 
    Document   : produto
    Created on : 15/06/2018, 18:33:57
    Author     : Aluno
--%>
...
<html>
    ...
    <body>
        ...
        <!--Detalhes -->
        <div class="areaDetalheProduto">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 justify-content-center">
                        <figure >
                            <img src="data:image/jpg;base64,${produto.imagem}"  class="img-fluid" alt="Responsive image">                        
                        </figure>
                    </div>
                    <div class="col-sm-6">
                        <input type="hidden" name="id" value="${produto.id}" />
                        <a href="<c:url value='/'/>" <button type="button" class="btn btn-outline-info btn-lg">voltar</button></a>
                        <h1 id="produto">${produto.nome}</h1>
                        <br/>
                        <h2 id="valor">${produto.preco}</h2>
                        <br/>
                        ...
                        <form>
                            <div class="row">
                                <div class="col-md-2">
                                    <input value="1" min="1" type="number" id="quantidade" class="form-control" placeholder="">
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-primary">Comprar</button>
                                    <button id="${produto.id}" type="button" class="btn btn-outline-primary botaoAdicionar">Adiconar ao carrinho</button>
                                </div>
                            </div>
                        </form>
                    </div>
