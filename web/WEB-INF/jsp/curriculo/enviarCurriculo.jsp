<%-- 
    ...
    Created on : 03/06/2018, 21:00:42
    Author     : Raymison
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <form action="<c:url value='/adicionarCurriculo'/>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Nome</label>
                            <input name="nomeCandidato" id="txtNome" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Digite seu nome">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Endereço de email</label>
                            <input name="emailCandidato" id="txtEmail" type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                        </div>         
                        <div class="form-group">
                            <input type="file" name="arquivoCurriculo" id="exampleFormControlInput1" class="form-control" >Enviar currículo>
                        </div>
